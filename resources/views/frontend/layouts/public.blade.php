...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'PT. Elsyahfi Calibratech Mandiri (ECM) adalah Institusi Pengujian Fasilitas Kesehatan (IPFK) di Sumatera Barat yang menyediakan layanan kalibrasi dan inspeksi alat kesehatan.' }}">
    <meta name="keywords" content="ECM, PT. Elsyahfi Calibratech Mandiri, Kalibrasi alat kesehatan, IPFK, Sumatera Barat, Payakumbuh">
    <meta name="author" content="ECM">
    <meta property="og:title" content="{{ $title ?? config('app.name', 'ECM') }}">
    <meta property="og:description" content="{{ $description ?? 'Institusi Pengujian Fasilitas Kesehatan (IPFK) di Sumatera Barat - Kalibrasi dan Inspeksi Alat Kesehatan' }}">
    <meta property="og:image" content="{{ $ogImage ?? 'https://ecm.co.id/assets/img/ecm.png' }}">
